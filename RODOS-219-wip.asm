...
ROM_INIT:
	...
	call sub_c259h		;c1d5	cd 59 c2 	. Y .
	pop hl			;c1d8	e1 	.
	jr nz,lc234h		;c1d9	20 59 	  Y
lc1dbh:
	pop af			;c1db	f1 	.
	push de			;c1dc	d5 	.
	push bc			;c1dd	c5 	.
...
sub_c2cch:
	...
	call nz,sub_c399h		;c2e6	c4 99 c3 	. . .
	ld a,032h		;c2e9	3e 32 	> 2
	call sub_c259h		;c2eb	cd 59 c2 	. Y .
	call nz,sub_c399h		;c2ee	c4 99 c3 	. . .
...
INITIALISE_VARIABLES:
	...
	ld (iy+042h),a		;c33f	fd 77 42 	. w B
	ld (iy+043h),a		;c342	fd 77 43 	. w C
	ld (iy+044h),a		;c345	fd 77 44 	. w D
	...
	ld (iy+045h),a		;c363	fd 77 45 	. w E
...
lc3b2h:
	nop			;c3b2	00 	.
	add hl,bc			;c3b3	09 	.
	ex af,af'			;c3b4	08 	. ;adding a ' to make my editor happy.
	ld a,(bc)			;c3b5	0a 	.
	dec bc			;c3b6	0b 	.
	rst 38h			;c3b7	ff 	.
	rst 38h			;c3b8	ff 	.
	call c,063ffh		;c3b9	dc ff 63 	. . c
lc3bch:
	ld (06400h),a		;c3bc	32 00 64 	2 . d
	ld bc,00fafh		;c3bf	01 af 0f 	. . .
	inc c			;c3c2	0c 	.
sub_c3c3h:
	push iy		;c3c3	fd e5 	. .
	pop hl			;c3c5	e1 	.
...
sub_c61dh:
	...
	push hl			;c61f	e5 	.
	push bc			;c620	c5 	.
	call sub_c259h		;c621	cd 59 c2 	. Y .
	pop bc			;c624	c1 	.
	pop hl			;c625	e1 	.
	ret			;c626	c9 	.
lc627h:
...
RSX_RANDOM:
	...
	ld (ix-00fh),052h		;cbbd	dd 36 f1 52 	. 6 . R
...
lccech:
	...
	jp sub_d97dh		;ccf4	c3 7d d9 	. } .
RSX_EXEC:
	cp 002h		;ccf7	fe 02 	. .
	jp nc,MSG_TOO_MANY_PARAMETERS		;ccf9	d2 9f fb 	. . .
	and a			;ccfc	a7 	.
	call z,ld8dch		;ccfd	cc dc d8 	. . .
lcd00h:
...
ld2fdh:
	...
	jp sub_d97dh		;d333	c3 7d d9 	. } .
RSX_TITLE:
	cp 002h		;d336	fe 02 	. .
	jp nc,MSG_TOO_MANY_PARAMETERS		;d338	d2 9f fb 	. . .
	and a			;d33b	a7 	.
	call z,ld8dch		;d33c	cc dc d8 	. . .
...
lda47h:
	...
	ret			;da61	c9 	.
sub_da62h:
	ld a,(iy+013h)		;da62	fd 7e 13 	. ~ .
	ld (iy+003h),a		;da65	fd 77 03 	. w .
...
lddc5h:
	...
	call sub_c259h		;ddcb	cd 59 c2 	. Y .
...
sub_de02h:
	...
	call sub_c259h		;de0a	cd 59 c2 	. Y .
...
lde12h:
	...
	call sub_c259h		;de1a	cd 59 c2 	. Y .
...
ldf10h:
	...
	call sub_c259h		;df12	cd 59 c2 	. Y .
...
lf0c7h:
	...
	rst 30h			;f0cc	f7 	.
	ei			;f0cd	fb 	.
	defb 0fdh,0feh,0cdh	;illegal sequence		;f0ce	fd fe cd 	. . .
	adc a,e			;f0d1	8b 	.
	rst 28h			;f0d2	ef 	.
