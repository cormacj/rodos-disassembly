...
a%=0:|bget,@a%
if  a%<0 then rtest$(4)="|BGET end of file test:"+pass$ else rtest$(4)="|BGET end of file test:"+fail$
next
closein
openin "testfile.dat"
for l=0 to filesize
...
print using "####";a%;
print chr$(13);
if a%<>l then print:print "Error: |BGET failed - I expected ";l;" but got ";a%:rtest$(5)="|BGET read tests:"+fail$:call &bb18
Next
closein
print "Done"
if a=0 then Print "Press any key...":while inkey$="":wend
...
if a=0 then Print "Press any key...":while inkey$="":wend
|cls
rtest$(6)="|BGET+|POINT read tests:"+pass$
...
print using "####";a%;
print chr$(13);
if a%<>pnt then print:print "Error: |point failed - point ";pnt;" got ";a%:rtest$(6)="|BGET+|POINT read tests:"+fail$
Next
closein
print "Done"
if a=0 then Print "Press any key...":while inkey$="":wend
